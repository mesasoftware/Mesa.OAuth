namespace Mesa.OAuth.Framework
{
    ...
    public static class Error
    {
        public static Exception AccessDeniedToProtectedResource ( AccessOutcome outcome )
        {
            ...
            return string.IsNullOrEmpty ( outcome.AdditionalInfo )
                ? new AccessDeniedException ( outcome , string.Format ( "Access to resource \"{0}\" was denied" , uri ) )
                : new AccessDeniedException ( outcome ,
