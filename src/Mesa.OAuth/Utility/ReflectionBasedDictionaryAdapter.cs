...
namespace Mesa.OAuth.Utility
{
    ...
    public class ReflectionBasedDictionaryAdapter : IDictionary
    {
        ...
        public object? this [ object key ]
        {
            get
            {
                this.properties.TryGetValue ( key.ToString ( ) ?? string.Empty , out object? value );
        ...
        {
            return key is string value ? this.properties.ContainsKey ( value ) : throw new ArgumentException ( nameof ( key ) );
        }
